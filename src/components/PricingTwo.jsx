...
import { pricingOptionsTwo } from "../constant";
...
const PricingTwo = () => {
  return (
    <div>
      ...
      <h2 className="text-xl sm:text-4xl font-semibold lg:text-4xl text-neutral-700 text-left lg:-mt-14 lg:mr-[360px] mb-8 tracking-wider ml-20">
          Plans & Pricing
        </h2>
        <div className="flex flex-wrap">
          {pricingOptionsTwo.map((option, index) => (
            <div
              key={index}
